...
namespace onenotelink
{
    ...
    {		
		public const string EmailContent = 
			...
			"<ul><li>Check out <a href='https://developer.microsoft.com/graph/' target='_blank'>developer.microsoft.com/graph</a> " +
			"to start building Microsoft Graph apps today with all the latest tools, templates, and guidance to get started quickly.</li>" +
			"<li>Use the <a href='https://developer.microsoft.com/graph/graph-explorer' target='_blank'>Graph Explorer</a> to explore the rest of the APIs and start your testing.</li>" +
			"<li>Browse other <a href='https://github.com/search?q=org%3Amicrosoftgraph+-sample' target='_blank'>samples on GitHub</a> to see more of the APIs in action.</li></ul> " +
			"<h3>Give us feedback</h3> <p>If you have any trouble running this sample, please <a href='https://github.com/microsoftgraph/console-csharp-connect-sample/issues' target='_blank'>log an issue</a>." +
			"</p><p>For general questions about the Microsoft Graph API, post to <a href='https://stackoverflow.com/questions/tagged/microsoftgraph' target='blank'>Stack Overflow</a>. " +
			"Make sure that your questions or comments are tagged with [microsoftgraph].</p><p>Thanks and happy coding!<br>Your Microsoft Graph samples development team </p> " +
